...
public class ObjectFactory {
    ...
    private final static QName _GetTimeAsElapsedResponse_QNAME = new QName("http://ws.jaad.cibertec.edu/", "getTimeAsElapsedResponse");
    private final static QName _GetTimeAsElapsed_QNAME = new QName("http://ws.jaad.cibertec.edu/", "getTimeAsElapsed");
    private final static QName _GetTimeAsString_QNAME = new QName("http://ws.jaad.cibertec.edu/", "getTimeAsString");
    private final static QName _GetTimeAsStringResponse_QNAME = new QName("http://ws.jaad.cibertec.edu/", "getTimeAsStringResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaad.cibertec.edu/", name = "getTimeAsElapsedResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaad.cibertec.edu/", name = "getTimeAsElapsed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaad.cibertec.edu/", name = "getTimeAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaad.cibertec.edu/", name = "getTimeAsStringResponse")
