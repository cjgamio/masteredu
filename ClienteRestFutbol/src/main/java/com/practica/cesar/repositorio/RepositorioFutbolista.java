package com.practica.cesar.repositorio;
...
public class RepositorioFutbolista {
	...
	static{
		...
		Futbolista f1 = new Futbolista("f1", "ces", 26, fecha.getTime());
		fecha.add(Calendar.YEAR, -2);
		Futbolista f2 = new Futbolista("f2", "fio", 16, fecha.getTime());
		fecha.add(Calendar.YEAR, -10);
		Futbolista f3 = new Futbolista("f3", "ros", 36, fecha.getTime());
		fecha.add(Calendar.YEAR, -10);
		Futbolista f4 = new Futbolista("f4", "augu", 46, fecha.getTime());
